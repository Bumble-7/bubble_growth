#!/bin/bash
#SBATCH --job-name=5micron         # Job name
#SBATCH -N 1 #Number of nodes
#SBATCH --ntasks-per-node=34  #Number of core per node
...
mpirun -np 30 multiRegionPhaseChangeFlow -parallel > output.log 
# chmod +x All* par*
# ./parReconstructPar 48 log.parReconst
# decomposePar -force